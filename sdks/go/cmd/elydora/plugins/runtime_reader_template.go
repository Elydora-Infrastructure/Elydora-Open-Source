...
var protectedRuntimeFileReader = fmt.Sprintf(`const MAX_PROTECTED_SECRET_BYTES = %d;
const MAX_PROTECTED_CONFIG_BYTES = %d;
...
`, maxProtectedSecretBytes, maxRuntimeConfigBytes)
